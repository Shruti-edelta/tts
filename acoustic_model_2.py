...
class LRSchedulerLogger(tf.keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs=None):
        ...
        # If the learning rate is a schedule, call it with epoch
...
# # Create the same learning rate schedule used during training
# initial_lr = 0.001
# decay_steps = 50  # total number of epochs
# alpha = 0.1       # final learning rate as a fraction of initial_lr
...
# # Generate learning rate values across epochs
# epochs = list(range(1, decay_steps + 1))
# lr_values = [lr_schedule(epoch).numpy() for epoch in epochs]

# # Plot
# plt.figure(figsize=(8, 5))
# plt.plot(epochs, lr_values, marker='o', label='CosineDecay LR')
