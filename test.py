...
padded = pad_sequences([phonemes], maxlen=165, padding='post')[0]
...
x_test = np.expand_dims(test_text[22], axis=0)  # Adding a batch dimension
y_true = np.expand_dims(test_mel[22], axis=0)  # Adding a batch dimension)
